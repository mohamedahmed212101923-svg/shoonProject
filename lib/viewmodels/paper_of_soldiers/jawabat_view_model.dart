...
import 'package:flutter_application_1/viewmodels/paper_of_soldiers/generate_maomoria.dart';
...
class JawabatViewModel extends ChangeNotifier {
  ...
  Future<void> printgwabma2moria({
    Map<String, dynamic>? extraData,

    required dynamic vm,
  }) async {
    generateMa2moria(
      leader: vm.leader, // هنا بنمرر الاسم والرتبة
    );
  }
}
