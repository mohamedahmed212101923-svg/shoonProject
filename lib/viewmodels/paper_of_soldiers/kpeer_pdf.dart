...
Future<pw.Document> generateShahadatkpeer(
  ...
  final List<String> footerTexts = [
    "تشهــــد وحدة تــــدريب مشترك الهيئة الهندسية بأن الرقم الكودى للوحدة هو(${toArabicNumbers("2791")})وجماعه البريد الحربى (${toArabicNumbers("24")}ج)",
    ...
    "تشهــــد وحدة تــــدريب مشترك الهيئة الهندسية بأن المذكور بعالية ليس عليه اى ديون اميريه",
  ];
